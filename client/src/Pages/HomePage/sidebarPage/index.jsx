...
class Sidebar extends React.PureComponent {
	...
	render () {
		const { indexColor, orderColor, productColor, touristColor, reportColor, settingColor, messageColor, indexSelect, orderSelect, productSelect, touristSelect, reportSelect, settingSelect, messageSelect } = this.state;
		const item = [
			{
				name: '首页',
				link: '/home/index',
